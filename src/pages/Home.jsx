...
export default function Home() {
  ...
  return (
    <div className="relative">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
            ...
            <span className="block mt-2 bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">
              Creator Operations Systems &amp; AI Apps
            </span>
          </h1>

          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-4">
            314,000 followers built from scratch. 50 million monthly views. Scaled multi-platform growth under real constraints — now I build the systems that make it repeatable.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            ...
            <span className="px-4 py-2 bg-purple-50 dark:bg-purple-900/20 rounded-full text-sm text-purple-700 dark:text-purple-300">
              📱 <strong>For brands:</strong> multi-platform growth
            </span>
          </div>
      ...
      <section
        ref={servicesRef}
        className={`py-20 bg-white dark:bg-gray-900 transition-all duration-700 delay-100 ${
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Systems for creators. Apps for businesses. Growth for brands.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Link
                key={index}
                to={service.link}
                className="group relative bg-gray-50 dark:bg-gray-950 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              >
      ...
      {/* Flipping & Liquidation — cash lane, kept but subordinate */}
      <section className="py-12 bg-white dark:bg-gray-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-orange-200 dark:border-orange-900/40 bg-orange-50/60 dark:bg-orange-950/20 p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <div className="text-4xl">🔄</div>
              <div className="flex-1 text-center sm:text-left">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1">
                  Also: Flipping &amp; Liquidation
                </h2>
                <p className="text-gray-700 dark:text-gray-300 font-medium mb-1">
                  I buy your inventory for cash.
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Send me photos of what you want to sell. Fair cash offer within 24 hours. No pressure, no obligation.
                </p>
              </div>
              <Link
                to="/flipping"
                className="flex-shrink-0 inline-flex items-center gap-2 px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-semibold transition-colors"
              >
                How it works →
              </Link>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Platform enforcement wiped out 250K+ followers overnight — four accounts gone, not for policy violations but as casualties of scaled multi-platform growth. That loss is why everything I build now is a system I own.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-blue-100 max-w-2xl mx-auto mb-4">
              Whether you need an AI app, a creator ops system, or a growth strategy,
